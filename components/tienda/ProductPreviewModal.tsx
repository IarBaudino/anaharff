...
export function ProductPreviewModal({ open, onClose, titulo, urls }: Props) {
    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-charcoal/10 px-4 py-3">
          <p className="font-display text-lg font-light text-charcoal">{titulo}</p>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="relative aspect-[3/4] max-h-[70vh] w-full bg-charcoal/[0.04] sm:aspect-[4/5]">
